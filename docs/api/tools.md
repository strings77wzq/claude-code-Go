...
- [Tool System Overview](../tools/overview) — Architecture and extension guide
- [Configuration Reference](./config) — Tool configuration
- [MCP Integration](../extension/mcp) — External tools via MCP