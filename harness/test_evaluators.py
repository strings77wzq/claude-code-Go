...
class TestToolCallCorrectnessEvaluator:
    ...
    def test_exact_match(self):
        ...
        expected_calls = [{"name": "bash", "params": {"command": "ls -la"}}]
        evaluator = ToolCallCorrectnessEvaluator(expected_calls)

        actual_calls = [{"name": "bash", "params": {"command": "ls -la"}}]
    ...
    def test_missing_tool_call(self):
        ...
        actual_calls = [{"name": "bash", "params": {"command": "ls"}}]
        result = evaluator.evaluate(actual_calls)
    ...
    def test_extra_tool_call(self):
        ...
        expected_calls = [{"name": "bash", "params": {"command": "ls"}}]
        evaluator = ToolCallCorrectnessEvaluator(expected_calls)
    ...
    def test_wrong_params(self):
        ...
        actual_calls = [{"name": "bash", "params": {"command": "pwd"}}]
        result = evaluator.evaluate(actual_calls)
    ...
    def test_param_containment(self):
        ...
        expected_calls = [{"name": "read", "params": {"file_path": "/test"}}]
        evaluator = ToolCallCorrectnessEvaluator(expected_calls)

        actual_calls = [{"name": "read", "params": {"file_path": "/test.txt"}}]
        result = evaluator.evaluate(actual_calls)
...
class TestTraceAnalyzer:
    ...
    def test_timeline(self):
        ...
        assert timeline[1]["tool_name"] == "bash"
