# noninteractive-permission-fastfail Specification

## Purpose
TBD - created by archiving change permission-mode-cli-and-noninteractive-fix. Update Purpose after archive.
## Requirements
